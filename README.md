...
This project contains some example of how to use Aurelia to build some simple widget, such as :
   ...
   - Custome form validation
      - Form validation based on bootstrap template

The whole projet structure is based on aurelia-skeleton-navigation (typescript) project, follow the documention bellow to build and run it.
